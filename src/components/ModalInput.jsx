          ...
          <form className="flex flex-col gap-4" >
            <div className="flex flex-col items-center gap-2 w-full">
              <div className="flex flex-col justify-start w-full gap-1">
                ...
                <input ref={nameRef} name="name" type="text" className="py-1 px-2 rounded-md border-black border bg-white focus:outline-green-primary" />
              </div>
              <div className="flex flex-row w-full justify-between gap-5">
                <div className="flex flex-col justify-start w-1/2 gap-1">
                  <label className="text-sm">Aplikasi</label>
                  <input ref={companyNameRef} name="companyName" type="text" className="py-1 px-2 rounded-md border-black border bg-white focus:outline-green-primary" />
                </div>
                <div className="flex flex-col justify-start w-1/2 gap-1">
                  <label className="text-sm">Tipe</label>
                  <input ref={typeRef} name="type" defaultValue="discount" type="text" className="py-1 px-2 rounded-md border-black border bg-white focus:outline-green-primary" />
                </div>
              </div>
              <div className="flex flex-row w-full justify-between gap-5">
                <div className="flex flex-col justify-start w-1/2 gap-1">
                  <label className="text-sm">Nilai</label>
                  <input ref={valueRef} name="value" type="number" className="py-1 px-2 rounded-md border-black border bg-white focus:outline-green-primary" />
                </div>
                <div className="flex flex-col justify-start w-1/2 gap-1">
                  <label className="text-sm">Minimum Pembelian</label>
                  <input ref={minTransactionRef} name="minTransaction" type="number" className="py-1 px-2 rounded-md border-black border bg-white focus:outline-green-primary" />
                </div>
              </div>
              <div className="flex flex-row w-full justify-between gap-5">
                <div className="flex flex-col justify-start w-1/2 gap-1">
                  <label className="text-sm">Minimum Poin</label>
                  <input ref={priceRef} name="price" type="number" className="py-1 px-2 rounded-md border-black border bg-white focus:outline-green-primary" />
                </div>
                <div className="flex flex-col justify-start w-1/2 gap-1">
                  <label className="text-sm">Jumlah</label>
                  <input ref={quantityRef} name="quantity" type="number" className="py-1 px-2 rounded-md border-black border bg-white focus:outline-green-primary" />
                </div>
              </div>
              <div className="flex flex-col justify-start w-full gap-1">
                <label className="text-sm">Kode Voucher</label>
                <input ref={voucherCodeRef} name="voucherCode" type="text" className="uppercase py-1 px-2 rounded-md border-black border bg-white focus:outline-green-primary" />
              </div>
            </div>
